...
export type ResourceName = "webhooks"|"widgets"|"metrics"|"provisioning"|"mqttConnectionManagement";
export const ResourceTypeArray: ResourceName[] = ["webhooks","widgets","metrics","provisioning","mqttConnectionManagement"];
