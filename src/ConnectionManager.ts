...
import { ConnectionDeclaration, ConnectionDeclarations, GenericHookConnection, BridgeAuthConnection, MqttConnection, GitHubDiscussionConnection, GitHubDiscussionSpace, GitHubIssueConnection, GitHubProjectConnection, GitHubRepoConnection, GitHubUserSpace, GitLabIssueConnection, GitLabRepoConnection, IConnection, IConnectionState, JiraProjectConnection } from "./Connections";
...
export class ConnectionManager extends EventEmitter {
    ...
    public getConnectionsForMqtt(hookId: string): MqttConnection[] {
        return this.connections.filter((c) => (c instanceof MqttConnection && c.hookId === hookId)) as MqttConnection[];
    }
